...
# 배경 이미지 불러오기
background = pygame.image.load("/Users/json/Desktop/PythonExercise/python_vscode/pygame_basic/background.jpg")
...
enemy_y_pos = (screen_height - enemy_height)/2  # 화면 세로 크기 가장 아래
